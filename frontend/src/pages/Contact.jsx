...
// Luxury Shimmer Skeleton for Contact Page
function ContactSkeleton() {
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:gap-8 items-start">
      {/* Sidebar Skeleton */}
      <div className="lg:col-span-4 flex flex-col gap-3 sm:gap-4 order-2 lg:order-1">
        <div className="grid grid-cols-2 lg:grid-cols-1 gap-2.5 sm:gap-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="relative overflow-hidden rounded-xl sm:rounded-2xl border border-white/5 bg-[#0e0e0e] p-3 sm:p-4 min-h-[72px] sm:min-h-[85px] flex items-center gap-3"
            >
              ...
              <div className="h-9 w-9 sm:h-11 sm:w-11 rounded-full bg-neutral-900 shrink-0" />
        ...
        <div className="relative overflow-hidden rounded-xl sm:rounded-2xl border border-white/5 bg-[#0e0e0e] p-5 text-center min-h-[140px] flex flex-col justify-center items-center gap-2">
          <div className="absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-gradient-to-r from-transparent via-[#D4AF37]/10 to-transparent" />
          <div className="h-3 w-32 rounded bg-neutral-900" />
          <div className="h-3 w-48 rounded bg-neutral-900/60" />
          <div className="h-9 w-full rounded-full bg-neutral-900 mt-2" />
        </div>
      </div>

      {/* Form Skeleton */}
      <div className="lg:col-span-8 relative overflow-hidden rounded-2xl sm:rounded-3xl border border-white/5 bg-[#0e0e0e] p-6 sm:p-10 order-1 lg:order-2 min-h-[460px] space-y-6">
        <div className="absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-gradient-to-r from-transparent via-[#D4AF37]/10 to-transparent" />
        <div className="h-7 w-48 rounded bg-neutral-900" />
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="h-11 rounded-xl bg-neutral-900" />
          <div className="h-11 rounded-xl bg-neutral-900" />
          <div className="h-11 rounded-xl bg-neutral-900" />
          <div className="h-11 rounded-xl bg-neutral-900" />
        </div>
        <div className="h-28 rounded-xl bg-neutral-900" />
        <div className="h-11 w-full rounded-full bg-neutral-900" />
      </div>
    </div>
  );
}
...
export default function Contact() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#050505] text-white font-sans pt-20 sm:pt-28 pb-16 sm:pb-20 select-none">
      ...
      <div className="relative mx-auto max-w-[1280px] px-3.5 sm:px-6 lg:px-8 z-10">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-8 sm:mb-12">
            <div className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full border border-[#D4AF37]/35 bg-[#0a0a0a]/80 px-4 sm:px-5 py-1.5 sm:py-2 text-[10px] sm:text-xs text-[#D4AF37] backdrop-blur-md tracking-[0.18em] sm:tracking-[0.25em] uppercase font-semibold shadow-[0_0_25px_rgba(212,175,55,0.18)]">
          ...
          {isDataLoading ? (
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:gap-8 items-start">
              ...
              <motion.div variants={fadeUp} className="lg:col-span-4 flex flex-col gap-3 sm:gap-4 order-2 lg:order-1">
                  ...
                  {contactInfo.map((info, index) => {
                    ...
                    return (
                      <motion.a
                        ...
                        whileHover={{ x: 4 }}
                        className="group flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 rounded-xl sm:rounded-2xl border border-white/10 bg-[#0a0a0a] p-2.5 sm:p-4 backdrop-blur-md transition-all duration-300 hover:border-[#D4AF37] hover:shadow-[0_0_20px_rgba(212,175,55,0.15)]"
                      >
                ...
                <div className="mt-1 sm:mt-2 p-3.5 sm:p-5 rounded-xl sm:rounded-2xl border border-[#D4AF37]/30 bg-[#0a0a0a] text-center shadow-[0_0_20px_rgba(0,0,0,0.5)]">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-[#25D366] bg-[#25D366] px-5 py-2 sm:py-2.5 text-[10px] sm:text-xs font-semibold tracking-wider text-black uppercase hover:bg-transparent hover:text-[#25D366] transition-all shadow-[0_0_15px_rgba(37,211,102,0.25)]"
                  >
              ...
              >
                ...
                <div className="relative mt-5 sm:mt-6">
                  <button
                    ...
                    className="group cursor-pointer flex w-full items-center justify-center gap-2 rounded-full border border-[#D4AF37] bg-[#D4AF37] px-6 sm:px-8 py-2.5 sm:py-3 text-xs font-semibold tracking-[0.2em] text-black uppercase transition-all duration-300 hover:bg-transparent hover:text-[#D4AF37] shadow-[0_0_20px_rgba(212,175,55,0.25)]"
                  >

...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-[#D4AF37]/20 bg-[#050505] text-white font-sans">
      ...
      <div className="relative mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-8 py-10 sm:py-12 lg:py-14 z-10">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-5">
          ...
          <div className="xl:col-span-1">
            <Link to="/" className="inline-flex items-center gap-3 shrink-0">
              <div className="flex h-10 w-10 items-center justify-center rounded-md bg-[#D4AF37] shadow-[0_0_18px_rgba(212,175,55,0.4)]">
                <span className="text-black text-lg font-bold">𝓐𝓢</span>
              </div>
              <span className="font-serif-custom text-xl font-bold tracking-widest text-[#D4AF37] uppercase">
                ARTISTRY
              </span>
            </Link>

            <p className="mt-4 max-w-sm text-xs sm:text-sm leading-relaxed text-gray-300 font-light">
              Arti Makeup Artist offers premium bridal artistry, luxury event
              makeup, and professional makeup academy training with an elegant,
            ...
            <div className="mt-5 flex items-center gap-3">
              <a
                ...
                className="group flex h-9 w-9 items-center justify-center rounded-full border border-[#D4AF37]/30 bg-black/60 text-gray-300 transition-all hover:border-[#D4AF37] hover:bg-[#D4AF37] hover:text-black"
                aria-label="Instagram"
              >
                <Instagram size={15} className="transition-transform group-hover:scale-110" />
              </a>
              ...
              <a
                ...
                aria-label="Facebook"
              >
                <Facebook size={15} className="transition-transform group-hover:scale-110" />
              </a>
              ...
              >
                <PinterestIcon className="h-[15px] w-[15px] transition-transform group-hover:scale-110" />
              </a>
            </div>
          </div>
          ...
          {/* Quick Links Column */}
          <div>
            <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-[0.22em] text-[#D4AF37]">
              Quick Links
            </h4>
            <ul className="mt-4 space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    to={link.href}
                    className="group inline-flex items-center gap-2 text-xs sm:text-sm text-gray-300 font-light transition-colors hover:text-[#D4AF37]"
                  >
                    <span className="h-px w-3 bg-[#D4AF37]/40 transition-all group-hover:w-5 group-hover:bg-[#D4AF37]" />
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="mt-4 space-y-3 text-xs sm:text-sm font-light text-gray-300">
              ...
              <div className="flex gap-3 items-start">
                <Clock size={14} className="mt-0.5 shrink-0 text-[#D4AF37]" />
                <p>
                  Mon - Sun: 9 AM - 8 PM
                  <br />
                  By Appointment Only
            ...
            <Link
              to="/contact"
              className="mt-4 inline-flex items-center gap-1.5 text-xs font-semibold tracking-wider text-[#D4AF37] uppercase transition-transform hover:translate-x-1"
            >
              Get In Touch
        ...
        <div className="mt-10 border-t border-white/10 pt-5">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-5 text-xs text-gray-400 font-light">
